...
from pages.locators import age, youths, data_mapper_svg_icon, youth_population, citizen, race, rob, language,\
    non_youths, gender, demographic_menu, data_mapper_header_xpath
...
def step_impl(context):
    data_mapper_header = context.common.find_element_by_xpath(data_mapper_header_xpath)
    assert data_mapper_header.is_displayed()==True, 'Data Mapper is not displayed'
